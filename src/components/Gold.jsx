...
<div className="w-full h-screen flex items-center justify-center bg-gray-800">
  <Card color="gray" variant="gradient" className="w-full max-w-screen-xl p-8">
    <CardHeader
      floated={false}
      shadow={false}
      color="transparent"
    ...
    <CardBody className="p-0">
      <ul className="flex flex-col gap-4">
        <li className="flex items-center gap-4">
          ...
          <Typography className="font-normal">Luxury Suite</Typography>
        </li>
        <li className="flex items-center gap-4">
          <span className="rounded-full border border-white/20 bg-white/20 p-1">
            <CheckIcon />
          </span>
          <Typography className="font-normal">Private Balcony with Lake View</Typography>
        </li>
        <li className="flex items-center gap-4">
          <span className="rounded-full border border-white/20 bg-white/20 p-1">
            <CheckIcon />
          </span>
          <Typography className="font-normal">King Size Bed</Typography>
        </li>
        <li className="flex items-center gap-4">
          <span className="rounded-full border border-white/20 bg-white/20 p-1">
            <CheckIcon />
        ...
        <li className="flex items-center gap-4">
          ...
          <Typography className="font-normal">Access to Spa and Wellness Center</Typography>
        </li>
      </ul>
    </CardBody>
