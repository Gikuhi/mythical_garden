  ...
  <CardBody className="p-0">
    <ul className="flex flex-col gap-4">
      <li className="flex items-center gap-4">
        ...
        <Typography className="font-normal">Luxurious queen-size bed</Typography>
      </li>
      <li className="flex items-center gap-4">
        <span className="rounded-full border border-white/20 bg-white/20 p-1">
          <CheckIcon />
      ...
      <li className="flex items-center gap-4">
        ...
        <Typography className="font-normal">Access to private beach</Typography>
      </li>
      <li className="flex items-center gap-4">
        <span className="rounded-full border border-white/20 bg-white/20 p-1">
          <CheckIcon />
        </span>
        <Typography className="font-normal">Free high-speed Wi-Fi</Typography>
      </li>
    </ul>
  </CardBody>
