...
<br/>
    ...
    <div className="max-w-sm rounded overflow-hidden shadow-lg mx-2">
        <img className="w-full" src="images/bed1.jpg" alt="Sunset in the mountains"/>
    ...
    {/* Silver */}
    <div className="max-w-sm rounded overflow-hidden shadow-lg mx-2">
        <img className="w-full" src="images/bed2.jpg" alt="Sunset in the mountains"/>
        <div className="px-6 py-4">
    ...
    {/* Gold */}
    <div className="max-w-sm rounded overflow-hidden shadow-lg mx-2">
        <img className="w-full" src="images/bed3.jpg" alt="Sunset in the mountains"/>
        <div className="px-6 py-4">
